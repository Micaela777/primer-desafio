...
class ReportPet extends HTMLElement{
  connectedCallback(){
        ...
        const addCharacteristics = this.querySelector(".characteristics-form")
        ...
        const sendForm = this.querySelector('.report-pet-button')
        sendForm.addEventListener('click', (e) => {
            ...
            if(!name || !pictureFile || !location || !lat || !lng){
                ...
                state.reportPet(name, pictureFile, location, lat, lng).then((data) => {
                    cs.petId = data.id
    ...
    render(){
        this.innerHTML = `
            ...
            <div class="report-pet-section">
                <div class="text-container">
                    <h2 class="report-pet-title">Reportar mascota</h2>
                    <h3 class="sub-title">Ingresá la siguiente información para realizar el reporte de la mascota</h3>
                </div>
                <div class="report-pet-container">
                    <form class="characteristics-form">
                        ...
                        <button class="add-characteristics">Agregar foto</button>
                    </form>    
                    <form class="map-form">
                        ...
                        <button class="map-search-button">Buscar</button>
                    </form>
                    <h2 class="missing-data-error-text">Algunos datos del formulario están incompletos.</h2>
                    <button class="report-pet-button">Reportar</button>
